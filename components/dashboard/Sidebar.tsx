        ...
        <nav className={styles.nav} aria-label={t("primary")}>
          ...
          <div className={styles['section-main']}>
            <div data-slot="section" className={styles.section}>
              ...
              <span className={styles.wrap}>
                <a className={styles['nav-link']} type="button" data-headlessui-state="" href="/orders">
                  <span className={styles.target} aria-hidden="true"></span>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
            ...
            <div data-slot="section" className={`max-lg:hidden ${styles.section}`}>
              <h3 className={styles.heading}>Recent Products</h3>
              <span className={styles.wrap}>
                <a className={styles['nav-link']} type="button" data-headlessui-state="" href="/events/1000">
                  <span className={styles.target} aria-hidden="true"></span>Bear Hug: Live in Concert </a>
              </span>
              <span className={styles.wrap}>
                <a className={styles['nav-link']} type="button" data-headlessui-state="" href="/events/1001">
                  <span className={styles.target} aria-hidden="true"></span>Six Fingers — DJ Set </a>
              </span>
              <span className={styles.wrap}>
                <a className={styles['nav-link']} type="button" data-headlessui-state="" href="/events/1002">
                  <span className={styles.target} aria-hidden="true"></span>We All Look The Same </a>
              </span>
              <span className={styles.wrap}>
                <a className={styles['nav-link']} type="button" data-headlessui-state="" href="/events/1003">
                  <span className={styles.target} aria-hidden="true"></span>Viking People </a>
              </span>
            </div>
            <div aria-hidden="true" className={styles.spacer}></div>
            <div data-slot="section" className={styles.section}>
              <span className={styles.wrap}>
                <a className={styles['nav-link']} type="button" data-headlessui-state="" href="#">
                  <span className={styles.target} aria-hidden="true"></span>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
